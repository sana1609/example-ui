...
# --------------------------------------------------------------------------
# File name : impact_discovery_ui_backup.py
                ...
                if len(js_files) == 0:
                    ...
                    for method in matched_files:
                        if "post" in method[1].lower():
                            method[1] = "POST"
                            method.append(
                                "POST requests are utilized to send data to a server to create or update a resource.")
                        elif "patch" in method[1].lower():
                            method[1] = "PATCH"
                            method.append(
                                "A PATCH request is similar to POST and PUT. However, its primary purpose is to apply "
                                "partial modifications to the resource.")
                        elif "put" in method[1].lower():
                            method[1] = "PUT"
                            method.append(
                                "PUT is similar to POST as it is used to send data to the server to create or update a "
                                "resource.")
                        elif "delete" in method[1].lower():
                            method[1] = "DELETE"
                            method.append(
                                "DELETE request method is used to delete resources indicated by a specific URL.")
